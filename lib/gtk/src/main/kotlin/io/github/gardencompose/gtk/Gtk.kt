package io.github.gardencompose.gtk

import androidx.compose.runtime.Composable
import io.github.gardencompose.ApplicationScope
import io.github.gardencompose.gtk.components.GtkApplicationWindow
import io.github.gardencompose.initializeApplication
...
@Deprecated(
    ...
    replaceWith = ReplaceWith(
        ...
        imports = ["io.github.gardencompose.gtk.gtkApplication"],
    ),
)
fun application(
    appId: String,
